...
Este archivo registra únicamente lo establecido por la novela. Distinguir siempre HECHO, HIPÓTESIS y PREGUNTA.
...
- Capítulo II cerrado: `manuscript/02-bajo-la-niebla.md` — **Bajo la niebla**.
...
- El valor desapareció del historial ordinario; una captura manual dañada conserva `37`.
- Hubo divergencia entre referencia inercial, altitud y horizonte visual.
- La cápsula se separó de Aster sin autorización consciente.
- Se perdió el enlace con Aster y las balizas accesibles.
...
- Hay raíces a múltiples alturas, bancos de niebla, vegetación y cascadas entre capas.
...
- Existe una columna de vapor lejana y varias geometrías/destellos todavía no identificados.
...
- El protagonista confirmó la respuesta con una corriente suave de la válvula del guante.
...
- La grabación no permite confirmar un organismo.
...
- Parte de las fibras está cubierta por una película húmeda y elástica no clasificada.
- El protagonista resbaló durante el regreso y golpeó la rodilla derecha.
...
- Uno de los discos quedó vacío y mostró después una línea oscura antes no visible.

### Primera fauna acuática confirmada
- Animales pequeños y planos viven dentro de los discos.
- Tamaño aproximado: dos dedos.
- Cuerpo gris azulado, muy fino, con puntos pálidos inferiores.
- Se mueven por ondulación.
- Parecen recorrer una película verdosa de la pared del disco; posible alimentación, no confirmada.
- Reaccionan a cambios asociados al calentador del traje antes de que el protagonista los perciba.
...
Confirmado: acuáticos, pequeños, planos, movimiento por ondulación, puntos pálidos, reacción a cambios del traje y vibraciones profundas.

No confirmado: dieta, reproducción, ciclo vital, anatomía interna, peligrosidad, relación con otros organismos, nombre.

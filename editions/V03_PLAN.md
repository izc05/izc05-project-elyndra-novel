...
La edición v0.2 termina en el Capítulo XIII. El manuscrito maestro llega ya al **Capítulo XXIII — Lo que entra**. La distancia es de diez capítulos y la actualización del PDF queda por tanto **necesaria**, no opcional a largo plazo.

Además, los textos de XIII, XIX, XX, XXI, XXII y XXIII han sido pulidos después de sus primeras versiones. La revisión más reciente de XXII conserva todos sus hechos, pero sustituye un cierre demasiado explicativo por una consecuencia corporal más limpia: el protagonista recuerda el apoyo que ya no estaba a la altura esperada y asume que una ruta conocida debe comprobarse antes de cargar peso. XXIII devuelve la comida al primer plano, fija por primera vez un recuento físico de raciones y avanza la observación de la película oscura sin convertirla en alimento humano.

No debe reconstruirse tomando v0.2 como fuente textual. La autoridad es `manuscript/` + `CONTINUITY.md` y, mientras la integración literal de XXI–XXIII siga pendiente por limitación de edición segura del archivo largo, los deltas `CONTINUITY_DELTA_XXI.md`, `CONTINUITY_DELTA_XXII.md` y `CONTINUITY_DELTA_XXIII.md`. La dirección visual vigente es `art/ILLUSTRATION_MANIFEST_V03.md`.
...
- XX: jornada de reposo en la cápsula por rigidez de rodilla; aparece una recepción anómala en banda de emergencia aproximadamente 37 segundos antes de una baliza automática. No se reproduce en dos ciclos posteriores y no se identifica su fuente. La revisión posterior poda explicaciones y fija con más claridad que la anomalía se descubre retrospectivamente en el búfer tras la transmisión; no fue observada en directo antes de que ocurriera.
...
- XXIII: la comida vuelve a ser presión explícita mediante un recuento físico: 11,5 raciones al inicio y 10,5 al final. La raíz desplazada de XXII continúa en su nueva posición y la alternativa superior se consolida como hábito. En la zona de placas, una criatura de seis apoyos realiza contactos repetidos con la película oscura y se observa material desplazándose por un tramo translúcido de su estructura tubular hacia el cuerpo. El capítulo registra **transferencia de material hacia el cuerpo**, pero no demuestra digestión, metabolismo, seguridad alimentaria ni compatibilidad humana. No se recoge nueva muestra, no se consumen reactivos y no hay ingestión de materia local.
...
9. Generar XXIII únicamente si la observación de la criatura puede mostrar una transferencia pequeña y físicamente plausible sin convertirla en corte anatómico, digestión visible o confirmación de alimento humano.

Si XVII–XXIII no alcanzan el estándar visual cuando XIV–XVI estén aprobados, se permite una apertura tipográfica sobria para esos capítulos en un checkpoint de lectura antes que introducir una imagen claramente inferior. No se permite usar concept art genérico, imágenes con texto incrustado o ilustraciones que revelen información no descubierta.
...
- Confirmar que contiene Prólogo + XXIII en orden.
- Confirmar que XIII, XIX, XX, XXI, XXII y XXIII corresponden a sus revisiones actuales.
...
- Verificar que XI no muestra Aster, X no resuelve la plataforma y XIV–XXIII respetan los límites de exposición/respiración del canon.
...
- Verificar que XXIII no convierta la transferencia por la estructura tubular en digestión confirmada, anatomía interna completa ni permiso visual para que el protagonista coma la película.
- Registrar páginas, tamaño final, fuentes y limitaciones conocidas.

## Bloqueo actual

El repositorio no conserva toda la biblioteca raster utilizada en v0.2 y las ilustraciones XIV–XXIII aún no están aprobadas. Tampoco existe en el repositorio una fuente visual verificable suficiente para afirmar una auditoría pixel a pixel de todas las imágenes antiguas. Por ello, este plan fija la reconstrucción como trabajo editorial obligatorio, pero **no declara una v0.3 ya maquetada ni visualmente revisada**.

Con diez capítulos de distancia, la edición no debe seguir creciendo indefinidamente por detrás del manuscrito. El siguiente checkpoint editorial debe ejecutarse en cuanto se resuelvan dos condiciones mínimas:
...
En ese punto, XVII–XXIII pueden entrar con aperturas tipográficas si sus imágenes todavía no alcanzan el estándar. No es necesario esperar a ilustrar todos los capítulos nuevos para reconstruir v0.3; sí es necesario evitar una edición visualmente peor que v0.2.
